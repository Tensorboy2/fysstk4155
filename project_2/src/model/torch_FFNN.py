'''
This module includes a FFNN that will be written using PyTorch 
and tested against our own FFNN.
'''
...
class torch_ffnn(nn.Module):
    '''
    Feed Forward Neural Network written using PyTorch.
    '''
    ...
    def train_NN(self, criterion, optimizer, x_train, y_train, epochs):
        '''
        Training function for the Torch FFNN.
        '''
        self.train()
        loss_history = []
